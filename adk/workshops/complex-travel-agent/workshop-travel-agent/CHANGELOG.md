...
## [0.1.1] - 2025-11-11
### Fixed
- Corrected the date calculation logic by re-introducing the `now` tool to the `ConciergeAgent`, allowing it to correctly resolve relative dates like "tomorrow".
